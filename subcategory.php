        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Subcategories</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Subcategory Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
    ...
    <script src="js/subcategoryAPI.js"></script>
