        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Instrument Type</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Instrument Type Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
    ...
    <script src="js/instrumentsAPI.js"></script>
    <script type="text/javascript">

        let params = new URLSearchParams(window.location.search);
        var instrumentTypeId=params.get("instrumentTypeId");     
        getAllInstruments(instrumentTypeId);
    </script>
</body>
